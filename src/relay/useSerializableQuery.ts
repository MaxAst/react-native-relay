...
// This hook converts a serializable preloaded query into Relay's PreloadedQuery object.
// It also writes this serializable preloaded query into the QueryResponseCache,
// so we the network layer can use these cache results when fetching data in `usePreloadedQuery`.
